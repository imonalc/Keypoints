...
#
#python3 extract_keypoints.py --datas Room Classroom Realistic Interior1 Interior2 --descriptors orb torb corb cporb sift tsift csift cpsift spoint tspoint cspoint cpspoint alike talike calike cpalike sphorb --solver GSM_wRT --inliers "5PA"
#
#python3 extract_keypoints.py --datas Room Classroom Realistic Interior1 Interior2 --descriptors orb torb corb cporb sift tsift csift cpsift spoint tspoint cspoint cpspoint alike talike calike cpalike sphorb --solver GSM_SK --inliers "5PA"
#
