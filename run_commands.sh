...
#
python3 extract_keypoints.py --datas Room Classroom Realistic Interior1 Interior2 --descriptors Ntspoint --solver GSM_wRT --inliers "5PA" --points 500
#
...
python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors Ntspoint --solver GSM_wRT --inliers "5PA" --points 500
