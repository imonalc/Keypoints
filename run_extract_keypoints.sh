# test
#python3 extract_keypoints.py --datas Room --descriptors Proposed1 superglue lightglue --solver GSM_wRT --inliers "5PA" --points 512
#python3 extract_keypoints_farm.py --descriptors Proposed1 orb --pose pose1 --solver GSM_wRT --inliers 5PA --points 500
...
# outdoor
python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors orb torb sift tsift spoint tspoint sphorb alike talike Proposed1 Proposed01 Proposed5 Proposed10 Proposed_nolimit Ltspoint Ftspoint --inliers "5PA" --points 256
python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors orb torb sift tsift spoint tspoint sphorb alike talike Proposed1 Proposed01 Proposed5 Proposed10 Proposed_nolimit Ltspoint Ftspoint --inliers "5PA" --points 512
python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors orb torb sift tsift spoint tspoint sphorb alike talike Proposed1 Proposed01 Proposed5 Proposed10 Proposed_nolimit Ltspoint Ftspoint --inliers "5PA" --points 1024
