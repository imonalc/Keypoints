# test
python3 extract_keypoints.py --datas Room --descriptors akaze_p --match BF_KNN --points 1000
...
python3 extract_keypoints.py --datas Room Classroom Realistic Interior1 Interior2 --descriptors cspoint --match MNN  --points 1000
python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors cspoint --match MNN  --points 1000
...
#python3 extract_keypoints.py --datas Room Classroom Realistic Interior1 Interior2 --descriptors orb_P sift_P spoint_P akaze_P aliked_P  --match MNN  --points 1000
#python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors orb_P sift_P spoint_P akaze_P aliked_P  --match MNN  --points 1000
#python3 extract_keypoints.py --datas Room Classroom Realistic Interior1 Interior2 --descriptors corb csift cakaze caliked  --match MNN  --points 1000
#python3 extract_keypoints.py --datas Urban1 Urban2 Urban3 Urban4 --descriptors corb csift cakaze caliked --match MNN  --points 1000
